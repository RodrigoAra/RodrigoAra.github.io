...
import { getDatabase, ref, set, onDisconnect } from 'https://www.gstatic.com/firebasejs/11.2.0/firebase-database.js' ; 
...
export { app , auth, db, onAuthStateChanged, signInAnonymously, ref, set, onDisconnect }; 
